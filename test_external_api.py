...
class TestExternalAPI(unittest.TestCase):
    ...
    def test_get_exchange_rates_failure(self, mock_request):
        ...
        self.assertTrue('API request failed with status code 500' in str(context.exception))
    ...
    def test_unsupported_currency(self):
        ...
        transaction = {
            "operationAmount": {
                "amount": "100",
                "currency": {
                    "code": "JPY"  # Неподдерживаемая валюта
                }
            }
        }
        ...
        self.assertTrue('Unsupported currency or missing operationAmount.' in str(context.exception))
